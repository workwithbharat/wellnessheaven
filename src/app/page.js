        ...
        <div className="container container-limit px-2 py-6">
          <div className="columns is-mobile">
            ...
            <div className="column is-8-desktop is-9-touch">
              ...
              <p className="is-size-4 mb-3">How the doctor's <strong><a href="https://hop.clickbank.net/?affiliate=aslibharat&vendor=puraclick&pg=research">unusual method</a></strong> works is nothing short of incredible... and it has changed everything we thought we knew about weight loss.</p>
              ...
              <p className="notification is-size-4" style={{ border: '2px solid #136e73', font: '20px' }}>If you have weight concerns, you should try this method for yourself right now. The $80 billion dollar weight loss industry do not want you to see <strong><a href="https://hop.clickbank.net/?affiliate=aslibharat&vendor=puraclick&pg=research">THIS VIDEO</a></strong> and discover the amazing fat-melting pantry food. Watch it now before it's too late.</p>
              <p className="is-size-4">Skeptical? I was too, but then I saw <strong><a href="https://hop.clickbank.net/?affiliate=aslibharat&vendor=puraclick&pg=research">this shocking proof</a></strong> for myself.</p>
